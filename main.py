...
def submit_data():
    ...
    if status == "Accepted":
        ...
        if first_name == " ":
            tkinter.messagebox.showwarning(title="Error", message="You have not entered your first name")
        elif last_name == "":
            tkinter.messagebox.showwarning(title="Error", message="You have not entered your last name")
        elif title == "":
            tkinter.messagebox.showwarning(title="Error", message="You have not entered your title")
        elif age == "":
            tkinter.messagebox.showwarning(title="Error", message="You have not entered your age")
        elif nationality == "":
            tkinter.messagebox.showwarning(title="Error", message="You have not entered your nationality")
        elif num_courses == "":
